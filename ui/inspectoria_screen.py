...
class _NameSearch(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        # Popup flotante
        self._popup = QListWidget(self.window() or self)
...
class _PaseTab(QWidget):
    ...
    def _build_ui(self):
        ...
        hdr.addWidget(self._make_label("Auto-reset:"))
        for ms, lbl in [(0,"∞"), (3000,"3s"), (5000,"5s"), (10000,"10s")]:
            btn = QPushButton(lbl)
            ...
            btn.clicked.connect(lambda _, v=ms, b=btn: self._set_auto_reset(v))
    ...
    def _registrar_pase(self, run: str, fecha_override: str | None = None,
        ...
        try:
            ...
            if auto_firmar:
                ...
                conn.close()
                if pase_id:
                    db.firmar_pase(pase_id[0], "Licencia médica")
...
class InspectoriaScreen(QWidget):
    ...
    def _build_ui(self):
        ...
        self._tabs.addTab(self._tab_notif,   "📱  Notificaciones WA")
